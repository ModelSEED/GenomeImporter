...
function GenomeImporter(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.import_external_genome = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GenomeImporter.import_external_genome",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GenomeImporter.status",
